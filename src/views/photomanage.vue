...
export default {
  ...
  closeInfoModelP:function (showmodel) {
      ...
      updateBanner:function(index){
        ...
        var _this=this;
          httpmethods.updateDataFuc(bannerdata,"/blogapi/admin/banner/",function () {
      ...
      queryAllBanner:function(){
        var _this=this;
           $.get("/blogapi/admin/banner/",function (data) {
             console.log(data);
             if(data.length>0){
      ...
      queryAllPhoto: function () {
        ...
        $.get("/blogapi/admin/photo/",function (data) {
          console.log(data);
  ...
  var _this=this;
   this.showinfo("添加banner:",infolist,true,oktext,info,function () {
      ...
      httpmethods.addDataFuc(photodata,"/blogapi/admin/banner/",function () {
        // 
  ...
  var _this=this;
   this.showinfo("添加图片:",infolist,true,oktext,info,function () {
      ...
      httpmethods.addDataFuc(photodata,"/blogapi/admin/photo/",function () {
        // 
    ...
    var _this=this;
        _this.showinfo("删除图片:",[],false,"删除","是否删除该图片?",function () {
          ...
          httpmethods.delDataFuc(photo,"/blogapi/admin/photo/",function () {
 ...
 console.log("删除 "+id);
    ...
    var _this=this;
        _this.showinfo("删除banner:",[],false,"删除","是否删除该banner图片?",function () {
          ...
          httpmethods.delDataFuc(bannerdata,"/blogapi/admin/banner/",function () {
