        ...
        this.showmodel=showmodel;
            ...
            delMenu:function (id) {
                ...
                this.showinfo("提示:",[],false,"确定","是否删除该菜单信息?",function () {
                    ...
                    httpmethods.delDataFuc(menu,"/blogapi/admin/permission/",function () {
            ...
            queryMenu: function (id) {
                ...
                $.get("/blogapi/admin/permission/"+id,function (data) {
                    ...
                    _this.showinfo("菜单信息:",infolist,true,"确定","",function () {
                        ...
                        httpmethods.updateDataFuc(menudata,"/blogapi/admin/permission/",function () {
                ...
                this.showinfo("菜单信息:",infolist,true,"确定","",function () {
                    ...
                    httpmethods.addDataFuc(menudata,"/blogapi/admin/permission/",function () {
