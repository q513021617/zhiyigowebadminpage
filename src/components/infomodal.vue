<template>
<!--  -->
      <div class="modal fade show"  id="modal-default" style="display: block; padding-right: 17px;max-height:690px;" aria-modal="true">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div v-if="isArticle">
                ...
                {{infolist[0].tag}} <input :name="infolist[0].name" v-model="infolist[0].value"/><br/><br/>
                {{infolist[1].tag}} 
                <mavon-editor :name="infolist[1].name" v-model="infolist[1].value" @save="okmethod"  width="500px" height="500px"/>
                </div>
